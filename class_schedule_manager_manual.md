...
- 使用するにあたって  
  ...
  - めんどくさいからpyファイルとおなじディレクトリに設定CSVとソースCSVをおいてくれ!!!
  
##CSVファイルの命名規則及び形式
- `西暦_前期or後期_クラス名.csv` とする  
  ...
  例) `2019_first_1-3.csv`  
  
  5. なかは4x5の構造とする

- CSVファイル内記述規則
  1. 基本は 4x5 で記述し列が曜日に行が時間となるようにする
...
- この関数がやっちまうと` { 1:['Invalid date', '', ''], 2:['Invalid date', '', ''] ...} `という形式のデータが帰ってくる

- 今後拡張する予定()

###コードが汚くてすまん。いずれ書きfixす